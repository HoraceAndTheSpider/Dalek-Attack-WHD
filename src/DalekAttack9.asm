...
.copyOriginalPortraits
		...
		clr.b	(a0)
		lea	_p1PreviewRoster(pc),a0
		move.b	#$ff,(a0)
		lea	_p2PreviewRoster(pc),a0
		move.b	#$ff,(a0)
...
;
; WHDLF_NoError is set in ws_Flags, so a missing/unreadable file is handled
; directly by resload_LoadFile/WHDLoad, including the failing filename.
; We only add one shared check for a successfully loaded file of the wrong size.
LoadCharacterAsset
		move.l	d0,-(sp)		;preserve expected size across resload call
		move.l	(_resload,pc),a2
